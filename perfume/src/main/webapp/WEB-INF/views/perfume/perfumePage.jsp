...
<tr><td><a href="/main/detail?p_number=${PerfumeDTO.p_number}&f_name=${PerfumeDTO.f_name}&page=${pa.page}&perPageNum=${pa.perPageNum}">${PerfumeDTO.p_number}</a></td>
<td><a href="/main/detail?f_name=${PerfumeDTO.f_name}&p_number=${PerfumeDTO.p_number}&page=${pa.page}&perPageNum=${pa.perPageNum}">${PerfumeDTO.f_name}</a></td></tr>
