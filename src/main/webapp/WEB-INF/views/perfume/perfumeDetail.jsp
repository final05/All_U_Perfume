...
<c:if test="${sessionScope.kid != null}">
<td><input type="button" onclick="perlike('${sessionScope.kid}' , '${per.p_number}' , '${per.f_name}')" value="좋아요"/> ${per.f_like_heart}</td>
</c:if>	
<c:if test="${sessionScope.id != null}">
<td><input type="button" onclick="perlike('${sessionScope.id}' , '${per.p_number}' , '${per.f_name}')" value="좋아요"/> ${per.f_like_heart}</td>
</c:if>	
</tr>
...
<c:forEach items="${getReview}"  varStatus="status" var="re">
	...
	<tr>
		...
		<c:if test="${sessionScope.kid != null}">
				<input type="button" onclick="like('${sessionScope.id}', '${re.p_number}', '${re.r_number}', '${getDetail[status.index].f_name}')" value="좋아요"/></td>
		</c:if>
		...
		<td>${re.unlike_re_heart}
		
		<c:if test="${sessionScope.kid != null}">
			<input type="button" onclick="unLike('${sessionScope.id}', '${re.p_number}', '${re.r_number}', '${getDetail[status.index].f_name}')" value="싫어요"/></td>
		</c:if>
